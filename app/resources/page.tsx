...
import { BASE_URL, FAQS, MONTANA_LAWYER_REFERRAL_URL } from "@/app/lib/site";
    ...
    <main>
      ...
      <section className="attorney-section" id="attorney">
        ...
        <div className="attorney-options">
          <article>
            <h3>Northwest&apos;s attorney contact</h3>
            <p>This space is reserved for the attorney&apos;s verified name, firm, phone number, practice area, and relationship disclosure.</p>
          </article>
          <article>
